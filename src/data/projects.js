function youtubeThumbnail(embedUrl) {
  const id = embedUrl?.match(/embed\/([a-zA-Z0-9_-]+)/)?.[1];
...
export const projects = [
  ...
  },
  {
    ...
    externalLink:
      "https://play.google.com/store/apps/details?id=com.mysavedlikes.MySavedLikes2024&pli=1",
    description: [
  ...
  ...project,
  thumbnail: project.imageSrc || youtubeThumbnail(project.youtubeLink),
}));
