...
const Header = () => {
  ...
  // Add "is-loaded" on mount (triggers CSS animations)
  useEffect(() => {
    const el = headerRef.current;
    requestAnimationFrame(() => el?.classList.add("is-loaded"));
  }, []);

  // Tiny parallax on mouse move (disabled for reduced motion)
  useEffect(() => {
    const el = headerRef.current;
    ...
    const onMove = (e) => {
      ...
      // Move overlay and bubbles a touch
  ...
  return (
    <header className="hero-header" ref={headerRef}>
      ...
      <div className="overlay">
        ...
        <p className="hero-subtitle">Web & Mobile Development • Creative Solutions</p>
